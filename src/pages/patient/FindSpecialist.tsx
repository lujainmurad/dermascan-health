...
const FindSpecialist = () => {
  ...
  return (
    <AppLayout>
      <h1 className="text-2xl font-display font-bold text-foreground mb-2 tracking-tight">Find a Specialist</h1>
      <p className="text-muted-foreground text-sm mb-6">Search for verified dermatology specialists.</p>
      ...
      {loading ? (
        ...
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-4">
          {filtered.map(c => {
            ...
            return (
              <div key={c.id} className="clinical-card p-5">
